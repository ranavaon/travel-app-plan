...
import type { Trip, Activity, Accommodation, Attraction, ShoppingItem, PinnedPlace } from '../types';
...
export default function Trip() {
  ...
  const handleExportPdf = () => {
    const text = buildTripAsText(trip, days, allActivities, accommodations, attractions, shoppingItems);
